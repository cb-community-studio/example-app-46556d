...
const UsersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            ...
            <Column field="isAdmin" header="owner" body={tickTemplate3} style={{ minWidth: "8rem" }} />
            <Column field="remark" header="remark" body={pTemplate4} sortable style={{ minWidth: "8rem" }} />
